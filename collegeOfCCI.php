                ...
                <nav class="navbar navbar-inverse" role="navigation">
                    ...
                    <section class="page-heading">
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1>Col of Computing & Informatics </h1>
            ...
            <div class="grid-container">
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc1-title">Col of Computing & Informatics Book 1</h4>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc2-title">Col of Computing & Informatics Book 2</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc3-title">Col of Computing & Informatics Book 3</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc4-title">Col of Computing & Informatics Book 4</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc5-title">Col of Computing & Informatics Book 5</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc6-title">Col of Computing & Informatics Book 6</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc7-title">Col of Computing & Informatics Book 7</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc8-title">Col of Computing & Informatics Book 8</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
                ...
                <div class="grid-item">
                    <div class="service-item">
                        ...
                        <h4 id="coc9-title">Col of Computing & Informatics Book 9</h4>
                        <p>The book description is the pitch to the reader about why they should buy your book. </p>
